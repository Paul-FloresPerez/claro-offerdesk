  ...
  try {
    ...
    await prisma.salesRanking.create({
      data: {
        ...
        // Campo legado: el puesto visible se calcula al consultar el ranking.
        rankPosition: 0,
        ...
        pendingSales: parsed.data.pendingSales,
        rejectedSales: parsed.data.rejectedSales,
...
async function prepareRankingFormData(
  ...
  return {
    ...
    data: {
      ...
      pendingSales: formData.get("pendingSales"),
      rejectedSales: formData.get("rejectedSales"),
