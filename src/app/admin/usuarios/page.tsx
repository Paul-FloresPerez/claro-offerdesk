...
function ConnectedUsersBadge() {
  return (
    <span className="inline-flex h-10 w-fit items-center gap-2 rounded-lg border border-emerald-400/20 bg-emerald-400/10 px-3 text-sm font-semibold text-emerald-200">
