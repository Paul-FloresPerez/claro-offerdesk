  ...
  return (
    ...
    >
      ...
      >
        ...
        {media?.isFeatured ? (
          <p className="rounded-md border border-amber-300/20 bg-amber-400/10 px-3 py-2 text-sm font-semibold leading-5 text-amber-800 dark:text-amber-100 sm:col-span-2">
